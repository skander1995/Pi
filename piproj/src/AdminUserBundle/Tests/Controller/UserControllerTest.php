...
namespace AdminUserBundle\Tests\Controller;
...
class UserControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'user[datenaissance]' => new \DateTime(),
            'user[telephone]' => 'Lorem ipsum dolor sit amet',
            'user[photo_profile]' => 'Lorem ipsum dolor sit amet',
            'user[profilePicture]' => 'Lorem ipsum dolor sit amet',
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            ...
            'user[prenom]' => 'Changed',
            'user[datenaissance]' => new \DateTime(),
            'user[telephone]' => 'Changed',
            'user[photo_profile]' => 'Changed',
            'user[profilePicture]' => 'Changed',
            'user[createdAt]' => new \DateTime(),
            'user[updateAt]' => new \DateTime(),
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            ...
            'user_filter[datenaissance]' => new \DateTime(),
            'user_filter[telephone]' => 'First%',
            'user_filter[photo_profile]' => 'First%',
            'user_filter[profilePicture]' => 'First%',
            'user_filter[createdAt]' => new \DateTime(),
            'user_filter[updateAt]' => new \DateTime(),
