...
namespace EducBundle\Tests\Controller;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class AideControllerTest extends WebTestCase
{
    public function testCreate()
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/aide/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'aide[datepub]' => new \DateTime(),
            'aide[description]' => 'Lorem ipsum dolor sit amet',
            'aide[document]' => 'Lorem ipsum dolor sit amet',
            'aide[section]' => 'Lorem ipsum dolor sit amet',
            'aide[matiere]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/admin/aide/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'aide[datepub]' => new \DateTime(),
            'aide[description]' => 'Changed',
            'aide[document]' => 'Changed',
            'aide[section]' => 'Changed',
            'aide[matiere]' => 'Changed',
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'aide_filter[datepub]' => new \DateTime(),
            'aide_filter[description]' => 'First%',
            'aide_filter[document]' => 'First%',
            'aide_filter[section]' => 'First%',
            'aide_filter[matiere]' => 'First%',
