...
public class Covoiturage {
    ...
    public Covoiturage(Date DATEPUB, String LIEUDEPART, String LIEUARRIVE, float PRIX, int NBPLACE) {
        this.DATEPUB = DATEPUB;
        this.LIEUDEPART = LIEUDEPART;
        this.LIEUARRIVE = LIEUARRIVE;
        this.PRIX = PRIX;
    ...
    public Covoiturage(int ID_PUB, String LIEUDEPART, String LIEUARRIVE, Date DATEDEPART, float PRIX, int NBPLACE) {
        this.ID_PUB = ID_PUB;
        this.LIEUDEPART = LIEUDEPART;
        this.LIEUARRIVE = LIEUARRIVE;
        this.DATEDEPART = DATEDEPART;
    ...
    public Covoiturage(String DESCRIPTION, String LIEUDEPART, String LIEUARRIVE, Date DATEDEPART, float PRIX, int NBPLACE) {
        this.DESCRIPTION = DESCRIPTION;
        this.LIEUDEPART = LIEUDEPART;
        this.LIEUARRIVE = LIEUARRIVE;
        this.DATEDEPART = DATEDEPART;
