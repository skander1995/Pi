...
public class CommentaireDAO {
    ...
    public void AjouterCommentaire(Commentaire o, int idusr) {
    ...
    public ArrayList<Commentaire> getListTask(String json) {
        ...
        ArrayList<Commentaire> listeAides = new ArrayList<>();
        ...
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                //System.out.println("taswiraa :"+us.getPhotoProfil());
    ...
    ArrayList<Commentaire> e = new ArrayList();

    public List<Commentaire> consulterespace() {

        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/FosBundleProj/web/app_dev.php/tasks/comments/all");
