...
public class EspaceEducservice {
    ...
    public void Createpub(EspaceEduc o) {
        System.out.println(o.getId_usr());
    ...
    public void deletepub(int i) {
        // /tasks/delete_educ_mob/{id}
        System.out.println(i);
        String url = ToolsUtilities.ServerIp + ":" + ToolsUtilities.port + "/FosBundleProj/web/app_dev.php/tasks/delete_educ_mob/" + i;
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl(url);
        con.addResponseListener((e) -> {
            String str = new String(con.getResponseData());
    ...
    public ArrayList<EspaceEduc> getListTask(String json) {
        ...
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                float idusrs = Float.parseFloat(user.get("id").toString());

                //System.out.println(id);
                e.setId_pub((int) id);
                e.setUsername((String) idusr);
                e.setId_usr((int)idusrs);
